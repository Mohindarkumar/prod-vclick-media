// lucide-react no longer ships brand/social icons (Instagram, Facebook, LinkedIn,
// YouTube etc. were removed upstream). These minimal stroke-style SVGs are sized
// and styled to match lucide-react's icon API (size, className) so they drop
// into the same usage pattern everywhere else in the codebase uses lucide icons.
