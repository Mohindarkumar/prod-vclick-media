...
const STATIC_WORKS = [
  {
    featured_work_id: 1,
    title: 'Royal Desert Wedding',
    subtitle: 'Wedding Photography · 2-Day Event',
    description: 'An intimate desert ceremony for a royal family — 450 frames of emotion, light, and love.',
    category: 'Wedding',
  ...
  {
    featured_work_id: 2,
    title: 'National Day Expo',
    subtitle: 'Corporate Event · Abu Dhabi',
    description: 'Full media coverage of a 3-day national expo — photography, videography, and live streaming.',
    category: 'Corporate',
  ...
  {
    featured_work_id: 3,
    title: 'Couture Brand Campaign',
    subtitle: 'Fashion Editorial · Dubai',
    description: 'Luxury fashion campaign shot across iconic Dubai locations for a regional haute couture brand.',
    category: 'Fashion',
    cover_image_url: 'https://images.unsplash.com/photo-1509631179647-0177331693ae?q=80&w=1600&auto=format&fit=crop',
    stat_label: 'Looks Shot',
    stat_value: '24',
    link_type: 'gallery',
  },
  {
    featured_work_id: 4,
    title: 'Aerial City Portrait',
    subtitle: 'Drone Photography · UAE Skyline',
    description: 'Sweeping aerial perspectives over the UAE\'s most recognisable skylines and landscapes.',
    category: 'Drone',
    cover_image_url: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?q=80&w=1600&auto=format&fit=crop',
